$.widget('ui.interactiveMaps',
{
	...
	_create: function()
	{
		...
		this.element.append('<div class="wraper">' +
				...
				'<span class="editor-button" title="Enable editor">Wysiwyg Editor <span id="off-on"></span></span>' +
		...
		this.element.find('.editor-button').click(this, function(e) {
	...
	_clickArea: function(element, e)
	{
		...
		if(this.levelMap > 1)
		{
			...
			// zoom
			e.data.element.find('circle').attr({'r': 5 / scale, 'stroke-width': 1 / scale}).hide().fadeIn(1000);
	...
	_loadMaps: function()
	{
		...
		var widget = this;
		localStorage.setItem("currentMap", this.currentMap);
